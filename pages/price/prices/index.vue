  ...
  <div>
    ...
    <div class="container__inner">
      ...
      <p class="prices__paragraph__head">
        ...
        zapoznamy Cię podczas konsultacji.
      </p>
      <p class="prices__paragraph__head">
        Dla Twojej wygody akceptujemy płatności kartami płatniczymi i przelewem
        oraz możliwość rozłożenia płatności na raty w systemie MediRaty.
      </p>
      <div class="info__div">
      ...
      <div class="info__div">
        <div class="info__div__outer">
          ...
          <p>
            Korony i mosty cyrkonowe gwarantują najlepszą estetykę i są nie do
            odróżnienia od własnych zębów. Korony te wykonujemy szczególnie w
            przypadku górnych zębów. Korony i mosty na pobdudowie z metalu są
            tańszym rozwiązaniem i mogą być z powodzeniem wykorzystywane do
            odbudowy bocznych zębów, którymi żujemy pokarmy.
          </p>
          <p>
            <span>
      ...
      <div class="info__div">
        <div class="info__div__outer">
          ...
          <p>
            Implant to element zastępujący korzeń zęba. Leczenie zależy od tego,
            czy brakuje Ci jednego, czy kilku zębów. Jeśli brakuje Ci
            pojedynczych zębów, najlepszym rozwiązaniem będzie implant z koroną.
            W przypadku braku kilku zębów odpowiedni będzie most oparty na
            implantach. Najczęściej wykonywanymi zabiegami z zakresu chirurgii
            stomatologicznej są ekstrakcje zębów (usunięcie zęba). Znieczulenia,
            założenie szwów i wizyty kontrolne, wliczone są w cenę Twojego
            zabiegu.
          </p>
          <p>
            <span>
      ...
      <div class="info__div">
        <div class="info__div__outer">
          ...
          <p>
            Ortodoncja to dziedzina stomatologii zajmująca się leczeniem wad
            zgryzu. Aparat na zęby służy do przywracania właściwego ustawienia
            zębów w łuku oraz kontaktów między zębami górnymi i dolnymi. Jednym
            z najnowszych aparatów dostępnych na rynku jest Invisalign.
          </p>
          <p>
            <span>
      ...
      <div class="info__div">
        <div class="info__div__outer">
          ...
          <p>
            Wypełnienia kompozytowe - tzw. "plomby" to najczęstsza metoda
            leczenia próchnicy w zębach. Jeżeli ubytek w zębie jest głęboki,
            konieczne może być leczenie kanałowe zęba. Jeśli ząb jest mocno
            zniszczony, alternatywą dla wypełnień są inlaye wykonywane w
      ...
      <div class="info__div">
        <div class="info__div__outer">
          ...
          <p>
            Zabiegi profilaktyczne pozwalają pozbyć się kamienia i osadów
            nazębnych. Aby utrzymać zęby i dziąsła w dobrym stanie zalecamy, aby
            były wykonywane średnio co pół roku. Wykorzystujemy do tego celu
            skalery i piaskarki EMS z technologią NO-PAIN, dzięki którym zabieg
            jest dużo bardziej komfortowy i praktycznie bezbolesny.
          </p>
          <p>
            <span>
      ...
      <div class="info__div">
        <div class="info__div__outer">
          ...
          <p>
            ...
            indywidualnie dla każdego pacjenta na podstawie wycisku górnych i
            dolnych zębów. Stosuje się je w celu redukcji zaciskania zębów i u
            bruksistów.
          </p>
          <p>
            <span>
...
<style scoped lang="scss" src="../../offer/index.scss"></style>
