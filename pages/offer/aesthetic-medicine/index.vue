<template>
  <div>
    ...
    <div class="container__inner">
      <div class="inner">
        <h2 class="page__title">MEDYCYNA ESTETYCZNA</h2>
        <div class="first__div">
          ...
          <div>
            <p>
              <span>
                Medycyna estetyczna w Dental Factory? Poznaj BEAUTY by Dental
                Factory!
              </span>
              <br />
              <br />
              Dla nas liczy się naturalne piękno, subtelne efekty, Twoje dobro i
              zdrowie. Dlatego stworzyliśmy
              <br />
              BEAUTY by Dental Factory - miejsce dedykowane medycynie
              estetycznej.
              <br />
              <br />
      ...
      <div class="inner">
        ...
        <p>
          ...
          <br />
          <br />
          Wszystkie zabiegi w Dental Factory możesz opłacić korzystając
          wygodnego z systemu ratalnego MediRaty.
          <br />
          <br />
