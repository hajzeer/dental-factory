    ...
    <div class="container__inner">
      ...
      <div class="info__div">
        ...
        <div class="info__div__outer">
          ...
          <p>
            <span>
              Wypełnienia bioaktywne
            </span>
          </p>
          <ul>
            <li>
              ~ Alternatywa przed leczeniem kanałowym
            </li>
            <li>
              ~ Wbudowują w ząb wapń, fosfor i fluor
            </li>
            <li>
              ~ Brak nadwrażliwości po zabiegu
            </li>
          </ul>
          <p>
          ...
          <ul>
            <li>
              ~ estetyczne - wykonane z porcelany lub kompozytu
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ~ nieodpowiednie do dużych ubytków
            </li>
            <li>
              ~ słaba estetyka
            </li>
